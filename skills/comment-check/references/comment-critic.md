...
Feed me the scoped files or diff. If none was given, take the current diff
against the base branch (default `main`), including the working tree. Narration,
banners, commented-out corpses, workaround sermons — I hunt them all.
