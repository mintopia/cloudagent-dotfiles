(function() {
  ...
  function websocketUrl() {
    ...
    // ws:// and the companion's live-reload/click-tracking silently dies. Deriving
    // wss:// from location.protocol keeps it working both behind the TLS forward
    // (https -> wss) and on plain localhost (http -> ws).
